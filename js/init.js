...
function init() {
	...
	EarthNightTex = new THREE.TextureLoader().load("textures/8k_earth_nightmap.jpg" );
	EarthBump = new THREE.TextureLoader().load("textures/8k_earth_normal_map.png" );
	EarthSpec = new THREE.TextureLoader().load("textures/8k_earth_specular_map.png" );
